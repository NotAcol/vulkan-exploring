...
#define PushArrayNoZeroAligned(Arena, Type, Count, Align) \
    (T *)ArenaPushNoZeroAligned((Arena), sizeof(Type) * (Count), (Align))
#define PushArrayAligned(Arena, Type, Count, Align) \
    (T *)ArenaPushAligned((Arena), sizeof(Type) * (Count), (Align))

#define PushArrayNoZero(Arena, Type, Count) \
    (T *)ArenaPushNoZeroAligned((Arena), sizeof(Type) * (Count), AlignOf(Type))
#define PushArray(Arena, Type, Count) (T *)ArenaPushAligned((Arena), sizeof(Type) * (Count), AlignOf(Type))
